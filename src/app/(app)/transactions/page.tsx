...
export default async function TransactionsPage({
  ...
  for (const t of transactions) {
    if (t.type === "EXPENSE" || (t.type === "TRANSFER" && !t.toAccount)) {
  ...
  const summaryItems = [
    ...
    },
    {
      ...
      description: "Banyaknya transaksi yang tercatat bulan ini",
        ...
        <CardHeader className="flex flex-row items-center justify-between bg-gradient-to-r from-primary/5 to-transparent">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <div className="space-y-2">
                <Label htmlFor="toAccountId">Rekening Tujuan (khusus Transfer)</Label>
                <select
                  id="toAccountId"
                  name="toAccountId"
                  defaultValue=""
                ...
                <p className="text-xs text-muted-foreground">
                  Isi kalau tipe Transfer dan uangnya masuk ke rekening lain di sistem ini (mis.
                  tarik tunai ke Cash Tunai).
                </p>
              </div>
              <div className="space-y-2">
                    ...
                    <TableCell className="text-center">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            <Label htmlFor={`toAccountId-${items.id}`}>
                              Rekening Tujuan (khusus Transfer)
                            </Label>
                            <select
                              id={`toAccountId-${items.id}`}
                              name="toAccountId"
                              defaultValue={items.toAccountId ?? ""}
                              className="w-full rounded-md border bg-transparent px-3 py-2 text-sm"
                            >
                              <option value="">— Tidak ada (transfer ke luar) —</option>
                              {accounts.map((a) => (
                            ...
                            <p className="text-xs text-muted-foreground">
                              Isi kalau tipe Transfer dan uangnya masuk ke rekening lain di sistem
                              ini.
                            </p>
                          </div>
                          <div className="space-y-2">
